...
define('DOMAIN_URL', 'https://smartgold.blazeaisolutions.com/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
...
class Database
{
    ...
    private $db_user = "u194698150_subi";  // Change as required
    private $db_pass = "SmartGold@123";  // Change as required
    private $db_name = "u194698150_smartgold";    // Change as required
