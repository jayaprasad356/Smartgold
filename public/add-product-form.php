                    ...
                    <div class="box-body">
                        ...
                        <div id="packate_div" style="display:none">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        <label for="price">Price ():</label> <i class="text-danger asterik">*</i><input type="number" step="any" min='0' class="form-control" name="packate_price[]" id="packate_price" required />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                        ...
                        <div class="form-group" id="loose_stock_div" style="display:none;">
                            ...
                            <div class="form-group">
                                <label for="stock_unit"><br>Unit :</label>
